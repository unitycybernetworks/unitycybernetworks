document.addEventListener('DOMContentLoaded', function() {
    ...
    function setLoggedInState(isLoggedIn, username = '') {
        if (isLoggedIn) {
            ...
            // getStartedBtn.classList.add('hidden'); // REMOVED THIS LINE to keep Get Started visible
            ...
            // helpDeskBtn.classList.add('hidden'); // This line was previously removed to keep Help Desk visible
        }
    }
